...
//
//           NSLayoutConstraint.activate([
//               username.leftAnchor.constraint(equalTo: contentView.leftAnchor, constant: profilePhotoSize + 8),
//               username.topAnchor.constraint(equalTo: contentView.topAnchor),
//               username.rightAnchor.constraint(equalTo: contentView.rightAnchor, constant: -8),
